<?php
    ...
    if(!empty($_POST))
    {
        ...
        else
        {
            ...
            {
               $imageError ="Les fichiers autorisés sont: .jpg, .jped, .png, .gif";
               $isUploadSuccess = false;
            }
          ...
          <div class="row">
                    ...
                    <form class="form" action="<?php echo'update.php?id=' . $id; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category" name="category">
                              ...
                              <option value="" selected disabled>Choisir la catégorie</option> <!--  ligne erreur 13-->
                        ...
                        <button type="submit" href="index.php" class="btn btn-success"><i class="fas fa-pen"></i> Modifier</button>
            ...
            <div class="col-lg-6 site">
                            <div class="img-thumbnail">
                                <img style="width: 100%;"src="<?php echo '../images/' . $image; ?>" alt="img_error">
